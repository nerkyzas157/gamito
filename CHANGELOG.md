...
- Phase G2 SQLite persistence: WAL/busy-timeout connections, idempotent schema
  migrations, profile/plan/pantry repositories, survey tag rules, and
  `build_user_context`.
- Temp-file SQLite coverage for CRUD round-trips, cascade deletes, unique
  constraints, tag mapping, and `gamito db init` idempotency.
...
[Unreleased]: https://github.com/nerkyzas157/gamito/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/nerkyzas157/gamito/compare/v0.2.0...v0.3.0
